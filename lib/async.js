...
*	Asynchronously creates a .jshintrc file.
*
* @param {String} dest - .jshintrc destination directory
* @param {Object} [opts] - function options
* @param {String} [opts.template="default"] - .jshintrc template to use
* @param {Function} [clbk] - callback to invoke upon attempting to create a .jshintrc file
*/
function cp() {
	var args = arguments,
		nargs = args.length,
	...
	fpath = path.join( __dirname, tmpl, '.jshintrc' );
	dpath = path.join( dest, '.jshintrc' );
